...
gem 'flare',                      '1.1.0',        github: 'shanti-uva/flare',                tag: 'v1.1.0' #path: '../engines/flare'
gem 'kmaps_engine',               '3.8.1',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.8.1' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.2.0',        github: 'shanti-uva/subjects_engine',      tag: 'v1.2.0' #path: '../engines/subjects_engine'
