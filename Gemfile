...
gem 'kmaps_engine',               '3.3.5',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.3.5' #path: '../engines/kmaps_engine'
...
gem 'shanti_integration',         '3.1.2',        github: 'shanti-uva/shanti_integration',   tag: 'v3.1.2' #path: '../engines/shanti_integration'
...
gem 'subjects_engine',            '1.0.9',        github: 'shanti-uva/subjects_engine',      tag: 'v1.0.9' #path: '../engines/subjects_engine'
