...
gem 'flare',                      '1.3.2',        github: 'shanti-uva/flare',                tag: 'v1.3.2' #path: '../engines/flare'
gem 'ffi-icu',                    '0.2.0',        github: 'shanti-uva/ffi-icu',              tag: 'v0.2.0' #path: '../engines/ffi-icu'
gem 'kmaps_engine',               '6.2.9',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.2.9' #path: '../engines/kmaps_engine'
gem 'mms_integration',            '2.4.4',        github: 'thl/mms_integration',             tag: 'v2.4.4' #path: '../../thl/engines/mms_integration'
...
gem 'shanti_integration',         '3.5.2',        github: 'shanti-uva/shanti_integration',   tag: 'v3.5.2' #path: '../engines/shanti_integration'
...
gem 'subjects_engine',            '1.5.7',        github: 'shanti-uva/subjects_engine',      tag: 'v1.5.7' #path: '../engines/subjects_engine'
