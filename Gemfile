...
#gem 'webpacker'
gem 'shakapacker', '9.6.1' #'~> 6.5'   # or the latest 6.x you see on RubyGems
gem 'bootstrap-sass'
...
gem 'authenticated_system',       '2.6.2',        github: 'thl/authenticated_system',        tag: 'v2.6.2' #path: '../../thl/engines/authenticated_system'
...
gem 'kmaps_engine',               '7.1.0',        github: 'shanti-uva/kmaps_engine',         tag: 'v7.1.0' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.7.5',        github: 'shanti-uva/subjects_engine',      tag: 'v1.7.5' #path: '../engines/subjects_engine'
