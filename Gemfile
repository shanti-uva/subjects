...
gem 'active_resource_extensions', '2.0.6',        :git => 'git://github.com/thl/active_resource_extensions.git',  :tag => 'v2.0.6' #:path => '../../thl/engines/active_resource_extensions'
...
gem 'kmaps_engine',               '1.1.9',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.1.9' #:path => '../engines/kmaps_engine'
