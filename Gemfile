...
gem 'kmaps_engine',               '5.0.0',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.0.0' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.3.7',        github: 'shanti-uva/subjects_engine',      tag: 'v1.3.7' #path: '../engines/subjects_engine'
