...
gem 'kmaps_engine',               '3.0.4',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.0.4' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.0.3',        github: 'shanti-uva/subjects_engine',      tag: 'v1.0.3' #path: '../engines/subjects_engine'
