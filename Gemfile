...
gem 'acts_as_family_tree',        '1.1.5',        github: 'thl/acts_as_family_tree',         tag: 'v1.1.5' #path: '../../thl/engines/acts_as_family_tree'
...
gem 'flare',                      '1.1.2',        github: 'shanti-uva/flare',                tag: 'v1.1.2' #path: '../engines/flare'
gem 'kmaps_engine',               '3.9.4',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.9.4' #path: '../engines/kmaps_engine'
...
gem 'shanti_integration',         '3.3.6',        github: 'shanti-uva/shanti_integration',   tag: 'v3.3.6' #path: '../engines/shanti_integration'
...
gem 'subjects_engine',            '1.2.4',        github: 'shanti-uva/subjects_engine',      tag: 'v1.2.4'#path: '../engines/subjects_engine'
