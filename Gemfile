...
gem 'interface_utils',            '2.2.2',        github: 'thl/interface_utils',             tag: 'v2.2.2' #path: '../../thl/engines/interface_utils'
gem 'kmaps_engine',               '3.1.8',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.1.8' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.0.6',        github: 'shanti-uva/subjects_engine',      tag: 'v1.0.6' #path: '../engines/subjects_engine'
