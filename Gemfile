...
gem 'kmaps_engine',               '4.0.4',        github: 'shanti-uva/kmaps_engine',         tag: 'v4.0.4' #branch: 'persistent-search/MANU-4008/drc2r', path: '../engines/kmaps_engine' 
...
gem 'subjects_engine',            '1.3.0',        github: 'shanti-uva/subjects_engine',      tag: 'v1.3.0' #path: '../engines/subjects_engine', branch: 'persistent-search/MANU-4008/drc2r'
