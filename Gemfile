...
gem 'kmaps_engine',               '3.2.3',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.2.3' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.0.8',        github: 'shanti-uva/subjects_engine',      tag: 'v1.0.8' #path: '../engines/subjects_engine'
