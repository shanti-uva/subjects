...
gem 'acts_as_family_tree',        '1.0.4',        :git => 'git://github.com/thl/acts_as_family_tree.git',         :tag => 'v1.0.4' #:path => '../../thl/engines/acts_as_family_tree'
...
gem 'interface_utils',            '2.0.6',        :git => 'git://github.com/thl/interface_utils.git',             :tag => 'v2.0.6' #:path => '../../thl/engines/interface_utils'
gem 'kmaps_engine',               '1.7.1',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.7.1' #:path => '../engines/kmaps_engine'
