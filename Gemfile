...
gem 'active_resource_extensions', '2.0.7',        :git => 'git://github.com/thl/active_resource_extensions.git',  :tag => 'v2.0.7' #:path => '../../thl/engines/active_resource_extensions'
...
gem 'authenticated_system',       '2.1.2',        :git => 'git://github.com/thl/authenticated_system.git',        :tag => 'v2.1.2' #:path => '../../thl/engines/authenticated_system'
...
gem 'kmaps_engine',               '1.3.9',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.3.9' #:path => '../engines/kmaps_engine'
...
gem 'topical_map_to_kmaps',       '0.0.2',        :git => 'git://github.com/shanti-uva/topical_map_to_kmaps.git', :tag => 'v0.0.2' #:path => '../engines/topical_map_to_kmaps'
gem 'subjects_engine',            '0.1.7',        :git => 'git://github.com/shanti-uva/subjects_engine.git',      :tag => 'v0.1.7' #:path => '../engines/subjects_engine'
