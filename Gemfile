...
gem 'kmaps_engine',               '1.0.1',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',        :tag => 'v1.0.1' #:path => '../engines/kmaps_engine'
...
gem 'subjects_engine',            '0.0.2',        :git => 'git://github.com/shanti-uva/subjects_engine.git',     :tag => 'v0.0.2' #:path => '../engines/subjects_engine'
gem 'topical_map_integration',    '3.0.0',        :git => 'git://github.com/thl/topical_map_integration.git',    :tag => 'v3.0.0' #:path => '../../thl/engines/topical_map_integration'
gem 'universal_navigation',       '2.0.5',        :git => 'git://github.com/thl/universal_navigation.git',       :tag => 'v2.0.5' #:path => '../../thl/engines/universal_navigation'
