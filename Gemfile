...
gem 'authenticated_system',       '2.3.3',        github: 'thl/authenticated_system',        tag: 'v2.3.3' #path: '../../thl/engines/authenticated_system'
...
gem 'interface_utils',            '2.2.7',        github: 'thl/interface_utils',             tag: 'v2.2.7' #path: '../../thl/engines/interface_utils'
gem 'kmaps_engine',               '3.3.8',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.3.8' #path: '../engines/kmaps_engine'
...
gem 'shanti_integration',         '3.1.3',        github: 'shanti-uva/shanti_integration',   tag: 'v3.1.3' #path: '../engines/shanti_integration'
...
gem 'subjects_engine',            '1.1.0',        github: 'shanti-uva/subjects_engine',      tag: 'v1.1.0' #path: '../engines/subjects_engine'
gem 'universal_navigation',       '3.0.2',        github: 'thl/universal_navigation',        tag: 'v3.0.2' #path: '../../thl/engines/universal_navigation'
