...
gem 'kmaps_engine',               '6.4.2',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.4.2' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.6.0',        github: 'shanti-uva/subjects_engine',      tag: 'v1.6.0' #path: '../engines/subjects_engine'
