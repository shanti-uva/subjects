...
gem 'kmaps_engine',               '3.8.8',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.8.8' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.2.1',        github: 'shanti-uva/subjects_engine',      tag: 'v1.2.1' #path: '../engines/subjects_engine'
