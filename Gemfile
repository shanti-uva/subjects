...
gem 'interface_utils',            '2.0.7',        :git => 'git://github.com/thl/interface_utils.git',             :tag => 'v2.0.7' #:path => '../../thl/engines/interface_utils'
gem 'kmaps_engine',               '1.8.2',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.8.2' #:path => '../engines/kmaps_engine'
...
gem 'subjects_engine',            '0.2.6',        :git => 'git://github.com/shanti-uva/subjects_engine.git',      :tag => 'v0.2.6' #:path => '../engines/subjects_engine'
