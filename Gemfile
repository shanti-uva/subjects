...
gem 'flare',                      '1.3.0',        github: 'shanti-uva/flare',                tag: 'v1.3.0' #path: '../engines/flare'
gem 'ffi-icu',                    '0.2.0',        github: 'shanti-uva/ffi-icu',              tag: 'v0.2.0' #path: '../engines/ffi-icu'
gem 'kmaps_engine',               '6.2.1',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.2.1' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.5.6',        github: 'shanti-uva/subjects_engine',      tag: 'v1.5.6' #path: '../engines/subjects_engine'
