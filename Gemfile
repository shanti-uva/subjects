...
gem 'kmaps_engine',               '6.6.1',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.6.1' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.6.5',        github: 'shanti-uva/subjects_engine',      tag: 'v1.6.5' #path: '../engines/subjects_engine'
