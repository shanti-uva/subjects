...
gem 'mms_integration',            '2.4.0',        github: 'thl/mms_integration',             tag: 'v2.4.0' #path: '../../thl/engines/mms_integration'
gem 'places_integration',         '2.2.2',        github: 'thl/places_integration',          tag: 'v2.2.2' #path: '../../thl/engines/places_integration'
