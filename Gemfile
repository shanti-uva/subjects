...
gem 'kmaps_engine',               '5.4.9',        github: 'shanti-uva/kmaps_engine',         branch: 'refactor-flyout-search-result-popover/MANU-5491/drc2r' #tag: 'v5.4.9' #path: '../engines/kmaps_engine'
...
gem 'shanti_integration',         '3.4.5',        github: 'shanti-uva/shanti_integration',   branch: 'modify-kmaps-header/MANU-5492/drc2r' #tag: 'v3.4.5' #path: '../engines/shanti_integration'
...
gem 'subjects_engine',            '1.4.7',        github: 'shanti-uva/subjects_engine',      tag: 'v1.4.7' #path: '../engines/subjects_engine'
