...
gem 'kmaps_engine',               '3.9.0',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.9.0' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.2.2',        github: 'shanti-uva/subjects_engine',      tag: 'v1.2.2' #path: '../engines/subjects_engine'
