...
gem 'kmaps_engine',               '1.3.3',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.3.3' #:path => '../engines/kmaps_engine'
...
gem 'subjects_engine',            '0.1.5',        :git => 'git://github.com/shanti-uva/subjects_engine.git',      :tag => 'v0.1.5' #:path => '../engines/subjects_engine'
