...
gem 'kmaps_engine',               '6.9.8',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.9.8' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.7.3',        github: 'shanti-uva/subjects_engine',      tag: 'v1.7.3' #path: '../engines/subjects_engine'
