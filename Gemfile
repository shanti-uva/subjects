...
gem 'complex_dates',              '2.1.6',        github: 'thl/complex_dates',               tag: 'v2.1.6' #path: '../../thl/engines/complex_dates'
...
gem 'kmaps_engine',               '3.4.7',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.4.7' #path: '../engines/kmaps_engine'
