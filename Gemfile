...
gem 'interface_utils',            '2.1.2',        :git => 'git://github.com/thl/interface_utils.git',             :tag => 'v2.1.2' #:path => '../../thl/engines/interface_utils'
gem 'kmaps_engine',               '2.0.8',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v2.0.8' #:path => '../engines/kmaps_engine'
