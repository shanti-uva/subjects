...
gem 'kmaps_engine',               '1.6.3',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.6.3' #:path => '../engines/kmaps_engine'
...
gem 'shanti_integration',         '2.2.0',        :git => 'git://github.com/shanti-uva/shanti_integration.git',   :tag => 'v2.2.0' #:path => '../engines/shanti_integration'
