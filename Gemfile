...
gem 'kmaps_engine',               '4.0.6',        path: '../engines/kmaps_engine' #github: 'shanti-uva/kmaps_engine',         tag: 'v4.0.6'
...
gem 'subjects_engine',            '1.3.3',        github: 'shanti-uva/subjects_engine',      tag: 'v1.3.3' #path: '../engines/subjects_engine'
