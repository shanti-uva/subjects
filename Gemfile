...
gem 'interface_utils',            '2.0.4',        :git => 'git://github.com/thl/interface_utils.git',             :tag => 'v2.0.4' #:path => '../../thl/engines/interface_utils'
gem 'kmaps_engine',               '1.0.4',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.0.4' #:path => '../engines/kmaps_engine'
...
gem 'shanti_integration',         '2.1.2',        :git => 'git://github.com/shanti-uva/shanti_integration.git',   :tag => 'v2.1.2' #:path => '../engines/shanti_integration'
gem 'subjects_integration',       '0.0.2',        :git => 'git://github.com/shanti-uva/subjects_integration.git', :tag => 'v0.0.2' #:path => '../engines/subjects_integration'
...
gem 'subjects_engine',            '0.0.5',        :git => 'git://github.com/shanti-uva/subjects_engine.git',      :tag => 'v0.0.5' #:path => '../engines/subjects_engine'
gem 'universal_navigation',       '2.0.7',        :git => 'git://github.com/thl/universal_navigation.git',        :tag => 'v2.0.7' #:path => '../../thl/engines/universal_navigation'
