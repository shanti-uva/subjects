...
gem 'kmaps_engine',               '5.5.5',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.5.5' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.4.8',        github: 'shanti-uva/subjects_engine',      tag: 'v1.4.8' #path: '../engines/subjects_engine'
