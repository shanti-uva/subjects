...
gem 'complex_scripts',            '3.0.0',        github: 'thl/complex_scripts',             tag: 'v3.0.0' #path: '../../thl/engines/complex_scripts'
...
gem 'kmaps_engine',               '5.0.1',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.0.1' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.3.8',        github: 'shanti-uva/subjects_engine',      tag: 'v1.3.8' #path: '../engines/subjects_engine'
