...
gem 'complex_scripts',            '3.1.6',        github: 'thl/complex_scripts',             tag: 'v3.1.6' #path: '../../thl/engines/complex_scripts'
...
gem 'subjects_engine',            '1.6.3',        github: 'shanti-uva/subjects_engine',      tag: 'v1.6.3' #path: '../engines/subjects_engine'
