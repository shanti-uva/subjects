...
gem 'flare',                      '1.2.2',        github: 'shanti-uva/flare',                tag: 'v1.2.2' #path: '../engines/flare'
gem 'kmaps_engine',               '5.3.9',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.3.9' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.4.5',        github: 'shanti-uva/subjects_engine',      tag: 'v1.4.5' #path: '../engines/subjects_engine'
