...
gem 'subjects_engine',            '1.3.5',        github: 'shanti-uva/subjects_engine',      branch: 'related-features-summary-solr/MANU-4331/drc2r' #tag: 'v1.3.5', path: '../engines/subjects_engine'
