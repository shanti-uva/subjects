...
gem 'complex_dates',              '2.1.8',        github: 'thl/complex_dates',               tag: 'v2.1.8' #path: '../../thl/engines/complex_dates'
...
gem 'kmaps_engine',               '3.5.5',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.5.5' #path: '../engines/kmaps_engine'
