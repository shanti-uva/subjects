...
gem 'kmaps_engine',               '1.5.0',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.5.0' #:path => '../engines/kmaps_engine'
gem 'mms_integration',            '2.1.3',        :git => 'git://github.com/thl/mms_integration.git',             :tag => 'v2.1.3' #:path => '../../thl/engines/mms_integration'
...
gem 'subjects_engine',            '0.1.9',        :git => 'git://github.com/shanti-uva/subjects_engine.git',      :tag => 'v0.1.9' #:path => '../engines/subjects_engine'
