...
gem 'shanti_integration',         '2.1.0',        :git => 'git://github.com/shanti-uva/shanti_integration.git',   :tag => 'v2.1.0' #:path => '../engines/shanti_integration'
gem 'subjects_engine',            '0.0.4',        :git => 'git://github.com/shanti-uva/subjects_engine.git',      :tag => 'v0.0.4' #:path => '../engines/subjects_engine'
