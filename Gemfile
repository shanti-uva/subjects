...
gem 'complex_dates',              '2.3.2',        github: 'thl/complex_dates',               tag: 'v2.3.2' #path: '../../thl/engines/complex_dates'
...
gem 'kmaps_engine',               '5.9.8',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.9.8' #path: '../engines/kmaps_engine'
