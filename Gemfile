...
gem 'kmaps_engine',               '3.3.9',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.3.9' #path: '../engines/kmaps_engine'
...
gem 'shanti_integration',         '3.1.8',        github: 'shanti-uva/shanti_integration',   tag: 'v3.1.8' #path: '../engines/shanti_integration'
...
gem 'subjects_engine',            '1.1.4',        github: 'shanti-uva/subjects_engine',      tag: 'v1.1.4' #path: '../engines/subjects_engine'
gem 'universal_navigation',       '3.0.5',        github: 'thl/universal_navigation',        tag: 'v3.0.5' #path: '../../thl/engines/universal_navigation'
