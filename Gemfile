...
gem 'mms_integration',            '2.3.7',        github: 'thl/mms_integration',             tag: 'v2.3.7' #path: '../../thl/engines/mms_integration'
gem 'places_integration',         '2.2.0',        github: 'thl/places_integration',          tag: 'v2.2.0' #path: '../../thl/engines/places_integration'
...
gem 'subjects_engine',            '1.4.9',        github: 'shanti-uva/subjects_engine',      tag: 'v1.4.9' #path: '../engines/subjects_engine'
