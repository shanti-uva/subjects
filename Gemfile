...
gem 'kmaps_engine',               '4.0.5',        github: 'shanti-uva/kmaps_engine',         tag: 'v4.0.5' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.3.1',        github: 'shanti-uva/subjects_engine',      tag: 'v1.3.1' #path: '../engines/subjects_engine'
