...
gem 'complex_dates',              '2.1.9',        github: 'thl/complex_dates',               tag: 'v2.1.9' #path: '../../thl/engines/complex_dates'
...
gem 'kmaps_engine',               '3.6.9',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.6.9' #path: '../engines/kmaps_engine'
