...
gem 'complex_dates',              '2.3.1',        github: 'thl/complex_dates',               tag: 'v2.3.1' #path: '../../thl/engines/complex_dates'
...
gem 'kmaps_engine',               '5.9.6',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.9.6' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.5.1',        github: 'shanti-uva/subjects_engine',      tag: 'v1.5.1' #path: '../engines/subjects_engine'
