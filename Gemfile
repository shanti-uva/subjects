...
gem 'complex_scripts',            '2.2.9',        github: 'thl/complex_scripts',             tag: 'v2.2.9' #path: '../../thl/engines/complex_scripts'
...
gem 'kmaps_engine',               '4.1.0',        github: 'shanti-uva/kmaps_engine',         tag: 'v4.1.0' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.3.5',        github: 'shanti-uva/subjects_engine',      tag: 'v1.3.5' #path: '../engines/subjects_engine'
