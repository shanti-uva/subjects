...
gem 'kmaps_engine',               '6.3.2',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.3.2' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.5.8',        github: 'shanti-uva/subjects_engine',      tag: 'v1.5.8' #path: '../engines/subjects_engine'
