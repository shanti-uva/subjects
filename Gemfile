...
gem 'complex_dates',              '2.2.1',        github: 'thl/complex_dates',               tag: 'v2.2.1' #path: '../../thl/engines/complex_dates'
gem 'complex_scripts',            '2.2.7',        github: 'thl/complex_scripts',             tag: 'v2.2.7' #path: '../../thl/engines/complex_scripts'
gem 'interface_utils',            '2.2.9',        github: 'thl/interface_utils',             tag: 'v2.2.9' #path: '../../thl/engines/interface_utils'
gem 'flare',                      '1.0.1',        github: 'shanti-uva/flare',                tag: 'v1.0.1' #path: '../engines/flare'
gem 'kmaps_engine',               '3.7.6',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.7.6' #path: '../engines/kmaps_engine'
...
gem 'shanti_integration',         '3.3.2',        github: 'shanti-uva/shanti_integration',   tag: 'v3.3.2' #path: '../engines/shanti_integration'
...
gem 'subjects_engine',            '1.1.9',        github: 'shanti-uva/subjects_engine',      tag: 'v1.1.9' #path: '../engines/subjects_engine'
