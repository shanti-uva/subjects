...
gem 'kmaps_engine',               '3.8.3',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.8.3' #path: '../engines/kmaps_engine'
...
gem 'shanti_integration',         '3.3.4',        github: 'shanti-uva/shanti_integration',   tag: 'v3.3.4' #path: '../engines/shanti_integration'
