...
gem 'kmaps_engine',               '1.2.4',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.2.4' #:path => '../engines/kmaps_engine'
gem 'mms_integration',            '2.0.9',        :git => 'git://github.com/thl/mms_integration.git',             :tag => 'v2.0.9' #:path => '../../thl/engines/mms_integration'
