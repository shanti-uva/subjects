...
gem 'active_resource_extensions', '2.1.1',        :git => 'git://github.com/thl/active_resource_extensions.git',  :tag => 'v2.1.1' #:path => '../../thl/engines/active_resource_extensions'
...
gem 'kmaps_engine',               '2.2.2',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v2.2.2' #:path => '../engines/kmaps_engine'
...
gem 'subjects_engine',            '0.3.2',        :git => 'git://github.com/shanti-uva/subjects_engine.git',      :tag => 'v0.3.2' #:path => '../engines/subjects_engine'
