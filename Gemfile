...
gem 'authenticated_system',       '2.1.0',        :git => 'git://github.com/thl/authenticated_system.git',        :tag => 'v2.1.0' #:path => '../../thl/engines/authenticated_system'
...
gem 'interface_utils',            '2.0.3',        :git => 'git://github.com/thl/interface_utils.git',             :tag => 'v2.0.3' #:path => '../../thl/engines/interface_utils'
gem 'kmaps_engine',               '1.0.2',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.0.2' #:path => '../engines/kmaps_engine'
...
gem 'shanti_integration',         '2.0.9',        :git => 'git://github.com/shanti-uva/shanti_integration.git',   :tag => 'v2.0.9' #:path => '../engines/shanti_integration'
gem 'subjects_engine',            '0.0.3',        :git => 'git://github.com/shanti-uva/subjects_engine.git',      :tag => 'v0.0.3' #:path => '../engines/subjects_engine'
gem 'topical_map_integration',    '3.0.1',        :git => 'git://github.com/thl/topical_map_integration.git',     :tag => 'v3.0.1' #:path => '../../thl/engines/topical_map_integration'
...
gem 'universal_navigation',       '2.0.6',        :git => 'git://github.com/thl/universal_navigation.git',        :tag => 'v2.0.6' #:path => '../../thl/engines/universal_navigation'
