...
gem 'flare',                      '1.2.8',        github: 'shanti-uva/flare',                tag: 'v1.2.8' #path: '../engines/flare'
gem 'ffi-icu',                    '0.2.0',        github: 'shanti-uva/ffi-icu',              tag: 'v0.2.0' #path: '../engines/ffi-icu'
gem 'kmaps_engine',               '5.8.8',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.8.8' #path: '../engines/kmaps_engine'
gem 'mms_integration',            '2.4.1',        github: 'thl/mms_integration',             tag: 'v2.4.1' #path: '../../thl/engines/mms_integration'
gem 'places_integration',         '2.2.3',        github: 'thl/places_integration',          tag: 'v2.2.3' #path: '../../thl/engines/places_integration'
...
gem 'shanti_integration',         '3.4.7',        github: 'shanti-uva/shanti_integration',   tag: 'v3.4.7' #path: '../engines/shanti_integration'
...
gem 'subjects_engine',            '1.5.0',        github: 'shanti-uva/subjects_engine',      tag: 'v1.5.0' #path: '../engines/subjects_engine'
