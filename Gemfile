...
gem 'kmaps_engine',               '3.6.2',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.6.2' #path: '../engines/kmaps_engine'
gem 'mms_integration',            '2.2.8',        github: 'thl/mms_integration',             tag: 'v2.2.8' #path: '../../thl/engines/mms_integration'
