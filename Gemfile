...
gem 'kmaps_engine',               '1.1.5',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.1.5' #:path => '../engines/kmaps_engine'
...
gem 'subjects_engine',            '0.0.8',        :git => 'git://github.com/shanti-uva/subjects_engine.git',      :tag => 'v0.0.8' #:path => '../engines/subjects_engine'
