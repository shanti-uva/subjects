...
gem 'complex_scripts',            '3.0.1',        github: 'thl/complex_scripts',             tag: 'v3.0.1' #path: '../../thl/engines/complex_scripts'
...
gem 'subjects_engine',            '1.3.9',        github: 'shanti-uva/subjects_engine',      tag: 'v1.3.9' #path: '../engines/subjects_engine'
