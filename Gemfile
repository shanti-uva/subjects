...
gem 'kmaps_engine',               '5.1.5',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.1.5' #path: '../engines/kmaps_engine'
...
gem 'shanti_integration',         '3.4.3',        github: 'shanti-uva/shanti_integration',   tag: 'v3.4.3' #path: '../engines/shanti_integration'
