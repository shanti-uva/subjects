...
gem 'kmaps_engine',               '3.6.5',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.6.5' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.1.7',        github: 'shanti-uva/subjects_engine',      tag: 'v1.1.7' #path: '../engines/subjects_engine'
