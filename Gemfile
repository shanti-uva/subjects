...
gem 'kmaps_engine',               '3.9.7',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.9.7' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.2.5',        github: 'shanti-uva/subjects_engine',      tag: 'v1.2.5' #path: '../engines/subjects_engine'
