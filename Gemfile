...
gem 'kmaps_engine',               '4.1.6',        github: 'shanti-uva/kmaps_engine',         branch: 'related-features-summary-solr/MANU-4331/drc2r' #tag: 'v4.1.6' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.3.7',        github: 'shanti-uva/subjects_engine',      branch: 'related-features-summary-solr/MANU-4331/drc2r' #tag: 'v1.3.7' #path: '../engines/subjects_engine'
