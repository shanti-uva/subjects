...
gem 'kmaps_engine',               '3.4.1',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.4.1' #path: '../engines/kmaps_engine'
...
gem 'shanti_integration',         '3.2.2',        github: 'shanti-uva/shanti_integration',   tag: 'v3.2.2' #path: '../engines/shanti_integration'
