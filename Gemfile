...
gem 'kmaps_engine',               '1.0.3',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.0.3' #:path => '../engines/kmaps_engine'
...
gem 'shanti_integration',         '2.1.1',        :git => 'git://github.com/shanti-uva/shanti_integration.git',   :tag => 'v2.1.1' #:path => '../engines/shanti_integration'
gem 'subjects_integration',       '0.0.1',        :git => 'git://github.com/shanti-uva/subjects_integration.git', :tag => 'v0.0.1' #:path => '../engines/subjects_integration'
