...
gem 'kmaps_engine',               '3.9.2',        github: 'shanti-uva/kmaps_engine',         branch: 'theme-sync/MANU-3793/drc2r' #tag: 'v3.9.2' #path: '../engines/kmaps_engine'
...
gem 'shanti_integration',         '3.3.5',        github: 'shanti-uva/shanti_integration',   branch: 'theme-sync/MANU-3793/drc2r' #tag: 'v3.3.5' #path: '../engines/shanti_integration'
