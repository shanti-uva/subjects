...
gem 'active_resource_extensions', '2.0.9',        :git => 'git://github.com/thl/active_resource_extensions.git',  :tag => 'v2.0.9' #:path => '../../thl/engines/active_resource_extensions'
gem 'acts_as_family_tree',        '1.0.5',        :git => 'git://github.com/thl/acts_as_family_tree.git',         :tag => 'v1.0.5' #:path => '../../thl/engines/acts_as_family_tree'
gem 'authenticated_system',       '2.1.6',        :git => 'git://github.com/thl/authenticated_system.git',        :tag => 'v2.1.6' #:path => '../../thl/engines/authenticated_system'
...
gem 'interface_utils',            '2.0.8',        :git => 'git://github.com/thl/interface_utils.git',             :tag => 'v2.0.8' #:path => '../../thl/engines/interface_utils'
gem 'kmaps_engine',               '1.9.1',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.9.1' #:path => '../engines/kmaps_engine'
