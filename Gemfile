...
gem 'authenticated_system',       '2.1.1',        :git => 'git://github.com/thl/authenticated_system.git',        :tag => 'v2.1.1' #:path => '../../thl/engines/authenticated_system'
...
gem 'kmaps_engine',               '1.0.9',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.0.9' #:path => '../engines/kmaps_engine'
...
gem 'subjects_engine',            '0.0.6',        :git => 'git://github.com/shanti-uva/subjects_engine.git',      :tag => 'v0.0.6' #:path => '../engines/subjects_engine'
