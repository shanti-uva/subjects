...
gem 'kmaps_engine',               '4.0.0',        github: 'shanti-uva/kmaps_engine',         tag: 'v4.0.0' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.2.7',        github: 'shanti-uva/subjects_engine',      tag: 'v1.2.7' #path: '../engines/subjects_engine'
