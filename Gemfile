...
gem 'kmaps_engine',               '5.4.5',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.4.5' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.4.6',        github: 'shanti-uva/subjects_engine',      tag: 'v1.4.6' #path: '../engines/subjects_engine'
