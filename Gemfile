...
gem 'flare',                      '1.0.0',        github: 'shanti-uva/flare',                tag: 'v1.0.0' #path: '../engines/flare'
gem 'kmaps_engine',               '3.6.3',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.6.3' #path: '../engines/kmaps_engine'
gem 'mms_integration',            '2.3.0',        github: 'thl/mms_integration',             tag: 'v2.3.0' #path: '../../thl/engines/mms_integration'
...
gem 'subjects_engine',            '1.1.6',        github: 'shanti-uva/subjects_engine',      tag: 'v1.1.6' #path: '../engines/subjects_engine'
