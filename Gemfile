...
gem 'kmaps_engine',               '7.0.1',        github: 'shanti-uva/kmaps_engine',         tag: 'v7.0.1' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.7.4',        github: 'shanti-uva/subjects_engine',      tag: 'v1.7.4' #path: '../engines/subjects_engine'
