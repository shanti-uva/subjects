...
gem 'kmaps_engine',               '4.0.9',        github: 'shanti-uva/kmaps_engine',         branch: 'improve-related-features-interface/MANU-4311/drc2r' #tag: 'v4.0.9' #path: '../engines/kmaps_engine'
...
gem 'subjects_engine',            '1.3.4',        github: 'shanti-uva/subjects_engine',      branch: 'improve-related-features-interface/MANU-4311/drc2r' #tag: 'v1.3.4' #path: '../engines/subjects_engine'
